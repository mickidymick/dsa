...
sudo accel-config config-wq --group-id=0 --mode=shared --wq-size=128 --threshold=127 --type=user --priority=10 --name="app-0" --driver-name="user" --max-transfer-size $((2*1024*1024*1024)) --block-on-fault=0 dsa0/wq0.0
sudo accel-config config-engine dsa0/engine0.0 --group-id=0
sudo accel-config enable-device dsa0
sudo accel-config enable-wq dsa0/wq0.0

sudo accel-config config-wq --group-id=0 --mode=shared --wq-size=128 --threshold=127 --type=user --priority=10 --name="app-1" --driver-name="user" --max-transfer-size $((2*1024*1024*1024)) --block-on-fault=0 dsa2/wq2.0
...
sudo accel-config config-wq --group-id=0 --mode=shared --wq-size=128 --threshold=127 --type=user --priority=10 --name="app-2" --driver-name="user" --max-transfer-size $((2*1024*1024*1024)) --block-on-fault=0 dsa4/wq4.0
...
sudo accel-config config-wq --group-id=0 --mode=shared --wq-size=128 --threshold=127 --type=user --priority=10 --name="app-3" --driver-name="user" --max-transfer-size $((2*1024*1024*1024)) --block-on-fault=0 dsa6/wq6.0
